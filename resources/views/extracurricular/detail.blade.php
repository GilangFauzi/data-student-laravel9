                    ...
                    <div class="navbar-nav-right d-flex align-items-center" id="navbar-collapse">
                        ...
                        <div class="navbar-nav align-items-center">
                            <div class="nav-item d-flex align-items-center mt-3">
                                <h5>Detail Data Extracurricular</h5>
                            </div>
                        </div>
                        <!-- /Search -->
                            ...
                            <div class="col">
                                <div class="card">
                                    <div class="card-body">
                                            ...
                                            <table class="table table-striped">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td>{{ $eskul->name }}</td>
                                                        <td>
                                                            @if (count($eskul->student) == 0)
                                                                Student not found
                                                            @else
                                                                @foreach ($eskul->student as $kls)
                                                                    - {{ $kls->name }} <br>
                                                                @endforeach
                                                            @endif
                                                        </td>
                                        ...
                                        <a href="/extracurricular" class="btn btn-outline-secondary mt-3 float-end">Back</a>
                                    </div>
                                </div>
                            </div>
                        </div>
